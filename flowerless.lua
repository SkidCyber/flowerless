...
if not isfolder("flowerless") then
    makefolder("flowerless")
end

if not isfolder("flowerless/configs") then
    makefolder("flowerless/configs")
end

if not isfolder("flowerless/configs/da_hood") then
    makefolder("flowerless/configs/da_hood")
end
...
local nigga = (function() -- src/Lua/loader.lua
    ...
    function loaderOptions:new()
        ...
        MainTitle.Text = "flowerless.dahood"
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'flowerless<font color="rgb(168, 157, 159)">.dahood</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("flowerless.universal")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            local config = {
                                path = "flowerless/configs/da_hood/",
                                file = "",
                                config_name = ""
                            }
                            function config:get_list()
                                ...
                                if #listfiles("flowerless/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("flowerless/configs/da_hood") do
        ...
        elseif chosen_game == "universal" then
            (function() -- src/Lua/Scripts/universal/universal.lua
                ...
                local Interface = UserInterface:Create{title = 'flowerless<font color="rgb(168, 157, 159)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("flowerless.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
